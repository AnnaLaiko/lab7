...
<div class="container mt-5 ">
    <div class="jumbotron bg-dark">
        <div class="card card-body mx-5">
            <a class="btn btn-lg btn-info font-weight-bold text-dark" href="crud.php">Таблица пользователей</a>
        </div>
        <div class="card card-title mx-5 text-center text-dark">
            <h2>Список машин у пользователей:</h2>
        </div>
        <div class="card card-body mx-5">
        ...
        <form name="form2" id="form2" method="POST" action="php/second_table_delete_and_update.php">
            <div class="card card-body mx-5">
            ...
            <div class="card card-body mx-5 text-dark">
                <?php require_once 'php/fetch_tables_2.php' ?>
            </div>
        </form>
